import{j as n,d as _,u as z,v as I,c as f,a,E as V,G as w,g as y,f as o,F,b as B,x as k,h as m,o as d,n as S,e as j,H as E,_ as q}from"./index-DTp24uX2.js";import{F as H}from"./file-text-B8qLbbo6.js";import{C as A}from"./chart-column-B51aKyYn.js";/**
 * @license lucide-vue-next v1.0.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D=n("cpu",[["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M17 20v2",key:"1rnc9c"}],["path",{d:"M17 2v2",key:"11trls"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M2 17h2",key:"7oei6x"}],["path",{d:"M2 7h2",key:"asdhe0"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"M20 17h2",key:"1fpfkl"}],["path",{d:"M20 7h2",key:"1o8tra"}],["path",{d:"M7 20v2",key:"4gnj0m"}],["path",{d:"M7 2v2",key:"1i4yhu"}],["rect",{x:"4",y:"4",width:"16",height:"16",rx:"2",key:"1vbyd7"}],["rect",{x:"8",y:"8",width:"8",height:"8",rx:"1",key:"z9xiuo"}]]);/**
 * @license lucide-vue-next v1.0.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=n("send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]),G={class:"input-bar"},P={class:"input-row"},R=["placeholder","disabled"],U=["disabled"],$={class:"input-toolbar"},J=["title","onClick"],O=_({__name:"InputBar",props:k({disabled:{type:Boolean},placeholder:{}},{modelValue:{default:""},modelModifiers:{}}),emits:k(["send","fileSelected"],["update:modelValue"]),setup(i,{emit:v}){const c=z(),s=I(i,"modelValue"),r=v,h=m(),u=m(),b=[{id:"normal",label:"对话",icon:L,hint:"自由对话"},{id:"extraction",label:"文献提取",icon:H,hint:'输入"帮我搜寻：<描述>"开始提取'},{id:"hardware",label:"硬件控制",icon:D,hint:'输入"硬件控制：<指令>"操控设备'},{id:"experiment",label:"实验设计",icon:K,hint:'输入"实验设计：<描述>"设计实验'},{id:"analysis",label:"数据分析",icon:A,hint:'输入"数据分析"开始分析'}];function x(e){e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),p())}function p(){const e=s.value.trim();e&&(r("send",e),s.value="")}function M(){const e=h.value;e&&(e.style.height="auto",e.style.height=e.scrollHeight+"px")}function g(){var e;(e=u.value)==null||e.click()}function C(e){const t=e.target;t.files&&t.files.length>0&&(r("fileSelected",t.files[0]),t.value="")}return(e,t)=>(d(),f("div",G,[a("div",P,[V(a("textarea",{ref_key:"textarea",ref:h,"onUpdate:modelValue":t[0]||(t[0]=l=>s.value=l),class:"input-textarea",placeholder:i.placeholder||"输入消息... (Enter 发送, Shift+Enter 换行)",disabled:i.disabled,rows:"1",onKeydown:x,onInput:M},null,40,R),[[w,s.value]]),a("button",{class:"send-btn",disabled:i.disabled||!s.value.trim(),onClick:p},[y(o(T),{size:18})],8,U)]),a("div",$,[a("input",{ref_key:"fileInput",ref:u,type:"file",accept:".pdf,.csv,.txt,.json,.xlsx,.xls",class:"file-input-hidden",onChange:C},null,544),a("button",{class:"toolbar-btn",title:"上传文件",onClick:g},[y(o(N),{size:15})]),t[1]||(t[1]=a("span",{class:"toolbar-divider"},null,-1)),(d(),f(F,null,B(b,l=>a("button",{key:l.id,class:S(["toolbar-btn",{active:o(c).currentMode===l.id}]),title:l.hint,onClick:Q=>o(c).setMode(l.id)},[(d(),j(E(l.icon),{size:16}))],10,J)),64))])]))}}),Z=q(O,[["__scopeId","data-v-c912b717"]]);export{D as C,K as F,Z as I};
